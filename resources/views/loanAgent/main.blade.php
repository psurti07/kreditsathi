            ...
            <div class="col-md-6 col-lg-6 align-items-center m-auto self-apply-form mb-xl-0 mb-3">
                <div id="hero-8-form" class="r-24 mb-50">
                    ...
                    <form method="post" action="{{ route('loan.agent.send.otp') }}"
                        ...
                        <p class="mb-0 s-12 text-start text-dark d-flex align-items-start"><input type="checkbox" name="accept_tnc" id="promotion"
                        ...
                        <p class="mb-0 s-12 text-start text-dark d-flex align-items-start"><input type="checkbox" name="accept_agr" id="promotion"
