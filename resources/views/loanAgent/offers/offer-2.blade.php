    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-md-12 col-lg-6 order-2 order-md-2 order-lg-1 m-auto">
                <div class="img-block">
                    <img src="{{ asset('front/images/offer/loan-agent-elite-offer.png') }}" alt="selfapply nbfc list"
            ...
            <div class="col-md-12 col-lg-6 self-apply-form order-1 order-md-1 order-lg-2 mb-lg-0 mb-25">
                <div id="hero-8-form" class="r-06">
                    ...
                    <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a
                            ...
                            class="text-dark text-decoration-none"> Privacy Policy</a> of Kreditsathi.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="form-holder">
                    <div class="contact-form-notice">
                        ...
                        <p class="s-14">
                            ...
                            website https://Kreditsathi.com and NOT through any other source, directly or indirectly.
                            Thanks!
                        </p>
                    </div>
                </div>
