                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        ...
                                        <div class="form-group form-floating">
                                            <input id="pincode" name="pincode" type="text"
                                                class="form-control name numeric-input mb-0 py-0 r-12 border"
                                                placeholder="" value="{{ old('pincode') }}" maxlength="6"
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        ...
                                        <div class="form-group form-floating">
                                            <input id="city" name="city" type="text"
                                                class="form-control mb-0 py-0 r-12 border" placeholder=""
                                                value="{{ old('city') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        ...
                                        <div class="form-group form-floating">
                                            ...
                                            <select id="state" name="state"
                                                class="form-control mb-0 py-0 r-12 border"
                                    ...
                                    <div class="text-start">
                                        <button type="submit" class="custom-btn text-center submit w-100 mt-3"
                                            id="submit-btn">
