...
<div class="es-wrapper-color" style="background-color: #f9f9f9;">
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="
                ...
                " background="https://kreditsathi.com/public/front/images/bg-01.webp">
        <tbody>
        <tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <p
                                                                    style="font-size:2.2rem;color:#3480f7;font-weight:600">
                                                                    Congratulations !
                                                                </p>
                                                            </td>
                                                        </tr>
                            ...
                            <table class="es-content-body" cellspacing="0" cellpadding="0" align="center"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                               align="left"
                                               style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: collapse;border-spacing: 0;float: left;background-color: #f5fff9;border: 1px solid #3480f7;  border-radius: 12px; display: block;">
                                            <tbody>
                                            <tr>
                                                <td class="es-m-p20b" align="left"
                                                    style="padding: 0; margin: 0; width: 600px;">
                                                    <h3 style="text-align:center; color: #3480f7;">
                                                        Order Details
                                                    </h3>
                                                    <hr>
                                                    <table cellpadding="0" cellspacing="0"
                                                           width="100%" bgcolor="#ffffff"
                                                           style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: separate;border-spacing: 0; border-radius: 15px;/* border: 1px solid #3480f7; */ background-color: transparent;"
                                                           role="presentation">
                                                        <tbody>
                                                        <tr>
                                                            <td
