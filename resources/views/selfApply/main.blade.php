                        ...
                        <form method="post" action="{{ route('self.apply.send.otp') }}"
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="mobile" id="mobile"
                                            ...
                                            autocomplete="off" required maxlength="10" minlength="10" inputmode="numeric">
                                    </div>
                            ...
                            <p class="mb-0 s-14 text-start text-dark">By submitting the form and proceeding, you agree to
                                the <a href="{{ route('front.terms.conditions') }}" target="_blank"
                                    ...
                                    class="text-dark text-decoration-none" target="_blank">Kreditsathi.com.</a></p>
                        </form>
                    </div>
                </div>
                <div class="col-md-12 col-lg-6 col-12 m-auto mb-0">
                    <div class="img-block border-bottom border-3 border-primary">
                        <img src="{{ asset('front/images/self-apply-lendingpage-1.png') }}" alt="kreditsathi"
                                ...
                                <div id="sb-1-1" class="wow fadeInUp">
                                    <div class="statistic-block d-block bg-transparent">
                                        <div class="statistic-block-digit text-sm-start text-center">
                                            <h3 class="statistic-number w-500"><span
                                                    class="count-element">40</span>Million+
                                            </h3>
                                        </div>
                        ...
                        <div class="column-right">
                            <div class="cbox-1 ico-15 p-3 mb-2">
                                <div class="ico-wrap color--theme mt-1">
                                    <div class="cbox-1-ico bg--yellow-500 rounded-pill"><span
                            ...
                            <div class="ms-3">
                                ...
                                <p class="footer-mail-link ico-25">
                                    <a href="mailto:{{ env('INFO_EMAIL') }}"
                                        class="text-light">{{ env('INFO_EMAIL') }}</a>
                                </p>
                            </div>
                        </div>
                    </div>
