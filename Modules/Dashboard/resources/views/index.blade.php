...
@section('title','Welcome to Kreditsathi! ')
@push('style-css')
@endpush
                                                        ...
                                                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                                    <div class="d-flex flex-column">
                                                                        <div class="d-flex align-items-center mb-2">
                                                                            <a href="javascript:;" class="text-gray-900 text-hover-success fs-2 fw-bold me-1">{{ isset($agent->fullname) ? $agent->fullname : 'Kreditsathi Support' }}</a>
                                                                        ...
                                                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                                            <a href="javascript:;" class="d-flex align-items-center text-gray-700 text-hover-success me-5 mb-2">
                                                                                <i class="ki-duotone ki-phone fs-4 me-1"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                                                                {{ isset($agent->mobile) ? '+91 '.substr($agent->mobile, 0, 5) . ' ' . substr($agent->mobile, 5) : '+9187581-19471' }}
                                                                            </a>
                                                                            <a href="javascript:;" class="d-flex align-items-center text-gray-700 text-hover-success me-5 mb-2">
                                                                                <i class="ki-duotone ki-geolocation fs-4 me-1"><span class="path1"></span><span class="path2"></span></i>
...
">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <h6 class="text-danger"><marquee scrollamount="8" behavior="scroll">BE AWARE! We ask our customers to make payments ONLY on our website https://Kreditsathi.com and NOT through any other source, directly or indirectly. Thanks!</marquee></h6>
                </div>
            </div>
        </div>
    </div>
