...
if (!function_exists('sendPaymentGreetings')) {
    ...
    {
        /*if($mobile != '') {
            $smsmessage = "Dear Customer, Congratulations! Your loan application has been successfully submitted. Our Customer Executive will call you shortly. Thanks, Kreditsathi";
