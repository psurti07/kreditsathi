...
class LoanAgentController extends Controller
{
    ...
    public function getOffer1(Request $request)
    {
        try {
            ...
            $returnUrl = 'https://Kreditsathi.com/api/loan-agent/great-deal-offer-response';
    ...
    public function getOffer3_cipherpay(Request $request)
    {
        try {
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://kreditsathi.com/api/loan-agent/ultra-saver-offer-response';
    ...
    public function getOffer5(Request $request)
    {
        try {
            ...
            $returnUrl = 'https://kreditsathi.com/api/loan-agent/big-benefit-offer-response';
