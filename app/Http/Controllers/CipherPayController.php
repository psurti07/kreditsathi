...
-----END PUBLIC KEY-----';       //header key
    ...
    public function StatusEnquiry(Request $request)
    {
        ...
        $actualReturnUrl = $secondLastSegment === 'self-apply' ? 'https://kreditsathi.com/self-apply/premium-offer-response' : 'https://kreditsathi.com/loan-agent/ultra-saver-offer-response';

        $redirectUrl = $paymentMessage === 'Transaction Successfull' ? $actualReturnUrl : 'https://kreditsathi.com/cipher-payment-failed/';
